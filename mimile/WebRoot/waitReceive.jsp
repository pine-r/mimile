...
<link rel="stylesheet" type="text/css" href="css/waitReceive.css"/>
<html>
  <head>   
    <title>待完成订单</title>
  </head>
  	...
  	<div id="container">
  		...
  		<div id="line">
  			<div id="title-tip">
  			  	<a href="">首页&gt;</a>
  				<a href="">我的订单&gt;</a>
  				<a href="waitReceive.jsp">待完成</a>
  			</div>
  		</div>
  	
  		<div id="detail">
  			<div id="detail-left">
					<div><a href="unfinishOrder.jsp">未完成</a><br/></div>
					<div id="finish-link">待完成<br/></div>
